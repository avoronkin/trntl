...
module.exports = function (Transport) {
    ...
    * @return {promise}
    */
    Transport.prototype.ping = function () {
        return this.sendCommand(REQUEST.PING, [])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.auth = function (user, password) {
        return this.sendCommand(REQUEST.AUTH, [user, password, this.salt])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.eval = function (expession, ...args) {
        return this.sendCommand(REQUEST.EVAL, [expession, ...args])
    }

    Transport.prototype.execute = function (sql, options) {
        return this.sendCommand(REQUEST.EXECUTE, [sql, options])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.call = function (functionName, ...args) {
        return this.sendCommand(REQUEST.CALL, [functionName, ...args])
    }
    ...
    Transport.prototype.select = function (spaceId, indexId, iterator = 'eq', key = [], limit = 1, offset = 0) {
        return this.sendCommand(REQUEST.SELECT, [spaceId, indexId, iterator, key, limit, offset])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.insert = function (spaceId, tuple) {
        return this.sendCommand(REQUEST.INSERT, [spaceId, tuple])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.replace = function (spaceId, tuple) {
        return this.sendCommand(REQUEST.REPLACE, [spaceId, tuple])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.update = function (spaceId, indexId, key, ops) {
        return this.sendCommand(REQUEST.UPDATE, [spaceId, indexId, key, ops])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.upsert = function (spaceId, indexId, ops, tuple) {
        return this.sendCommand(REQUEST.UPSERT, [spaceId, indexId, ops, tuple])
    }
    ...
    * @return {promise}
    */
    Transport.prototype.delete = function (spaceId, indexId, key) {
        return this.sendCommand(REQUEST.DELETE, [spaceId, indexId, key])
    }
}
